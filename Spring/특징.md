...
2.  AOP(Aspect Oriented Programming)
    ...
    Aspect Oriented Programming은 관점 지향 프로그래밍이라는 뜻으로, 프로그래밍의 관심을 핵심 관점, 부가 관점으로 나눠서 이 관심 기준으로 모듈화하는 것을 의미한다. 핵심 관점에는 서비스에서 적용하고자 하는 핵심 business logic이 있을 수 있고, 이를 위한 DB 연결, logging, file 입출력 등은 부가 관점이 될 수 있다.
